...
export default function HomePage() {
	...
	const randomLightImage =
		previewLightImages[
			Math.floor(Math.random() * previewLightImages.length)
		];
		...
		<main className="container md:mx-auto max-w-6xl md:px-4 py-12 md:py-20 ">
					...
					>
						<div className="prose prose-fd max-w-none text-fd-foreground text-sm">
							<ol>
								...
								<li>
									Make sure <strong>Restricted mode</strong>{" "}
									is <strong>off</strong>.
								</li>
								<li>
									Click <strong>Browse</strong> community
									plugins.
								</li>
								<li>
									Search for{" "}
									<strong>&quot;Task Genius&quot;</strong>.
								</li>
								<li>
									Click <strong>Install</strong>.
								</li>
								<li>
									Once installed, <strong>Enable</strong> the
									plugin.
								</li>
							</ol>
						</div>
						...
						<div className="prose prose-fd max-w-none bg-transparent text-fd-foreground text-sm [&_code]:p-1">
							<ol>
								<li>
									...
									<strong>styles.css</strong>) from the{" "}
									<Link
								...
								<li>
									Reload Obsidian (or disable and re-enable
									the plugin).
								</li>
								<li>
			...
			<section className="border border-fd-border border-b-0 md:border-b pt-12 px-6 md:px-12 pb-6 relative">
				...
				<div className="prose prose-fd max-w-none">
					If you like the plugin, please consider leaving a review on
					the{" "}
					<Link
