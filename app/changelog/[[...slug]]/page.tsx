...
export default async function Page({
  ...
  if (slug) {
    ...
    contentClasses =
      "flex-1 px-8 flex space-x-6 border border-t-0 border-fd-border border-b p-6 bg-fd-background backdrop-blur-sm bg-opacity-50 md:pt-10 flex-col md:flex-row";
  } else {
