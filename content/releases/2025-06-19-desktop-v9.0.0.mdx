...
Introducing the new **Matrix view** (Kanban board), where you can drag and drop task cards between different workflow stages for more intuitive and efficient task management.
