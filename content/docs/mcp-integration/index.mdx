...
<div className="grid grid-cols-2 gap-4 mt-4">
  <a href="/docs/mcp-integration/clients/cursor" className="card">
    <h4>🖱️ Cursor</h4>
    <p>One-click setup with deeplink</p>
  </a>
  
  <a href="/docs/mcp-integration/clients/claude-desktop" className="card">
    <h4>🖥️ Claude Desktop</h4>
    <p>Native desktop integration</p>
  </a>
  
  <a href="/docs/mcp-integration/clients/claude-code" className="card">
    <h4>⌨️ Claude Code</h4>
    <p>Command-line interface</p>
  </a>
  
  <a href="/docs/mcp-integration/clients/vscode" className="card">
    <h4>📝 VS Code</h4>
