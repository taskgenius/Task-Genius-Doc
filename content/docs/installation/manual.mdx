...
1.  Download the latest release files (`main.js`, `manifest.json`, `styles.css`) from the [Task Genius Releases page](https://github.com/Quorafind/Obsidian-Task-Genius/releases) on GitHub.
