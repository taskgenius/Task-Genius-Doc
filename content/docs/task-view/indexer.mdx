...
If you find that the indexer is not working, you can try to force it to reindex by running the command `Task Genius: Force reindex all tasks`.

Or trying to reload Obsidian.
