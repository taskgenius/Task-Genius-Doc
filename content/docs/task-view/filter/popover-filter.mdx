...
- **Save Filter**: Click the <SaveIcon className="inline-block w-5 h-5" /> button to save the current filter configuration
- **Load Filter**: Click the <FolderOpenIcon className="inline-block w-5 h-5" /> button to load a previously saved filter configuration
